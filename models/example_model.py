...
class ExampleModel(DB, BASE):
    ...
    def get_example(self):
        return self.get(table_name=ExampleModel)
    ...
    def update_example(self, condition, update_value):
        return self.update(table_name=ExampleModel, condition=condition, update_value=update_value)

    def delete_example(self, condition):
        return self.delete(table_name=ExampleModel, condition=condition)

    def execute_example(self, query):
        return self.execute(query=query)

    def get_example_by(self, condition):
        return self.get_by(table_name=ExampleModel, condition=condition)
