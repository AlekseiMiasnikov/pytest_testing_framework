...
class ApiJsonplaceholder(BaseApi):
    @step('GET-запрос. Получение данных c url: https://jsonplaceholder.typicode.com//posts/1')
    def jsonplaceholder_get(self):
        return self.send_get(url='posts/1')

    @step('POST-запрос. Создание ресурса с url: https://jsonplaceholder.typicode.com//posts/')
